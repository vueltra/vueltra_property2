...
import { Listing, User, Category, ListingType, VerificationStatus, ListingStatus, Transaction, ListingReport, CityInsight, BlogPost, AppSettings, PropertyRequest } from '../types';
...
export const APP_CONFIG = {
  ...
  STORAGE_KEY: 'vueltra_db_v19_split', 
};
...
export const INITIAL_REQUESTS: PropertyRequest[] = [
  {
    id: 'req_1',
    userId: 'user_99',
...
export const POPULAR_LOCATIONS: string[] = [
  ...
  'Bali - Badung (Canggu/Seminyak)', 'Bali - Ubud', 'Bandung', 'Surabaya', 'Yogyakarta',
  'Bekasi', 'Depok', 'Bogor', 'Medan', 'Makassar', 'Semarang', 'Palembang',
  'Manado', 'Pekanbaru', 'Pontianak', 'Samarinda', 'Balikpapan', 'Denpasar'
];

export const LOCATION_GROUPS = [
  {
    region: 'JABODETABEK',
    cities: ['Jakarta Selatan', 'Jakarta Pusat', 'Jakarta Utara', 'Jakarta Barat', 'Jakarta Timur', 'Tangerang Selatan', 'Bekasi', 'Depok', 'Bogor', 'Tangerang Kota', 'Cikarang']
  },
  {
    region: 'JAWA BARAT',
    cities: ['Bandung', 'Cimahi', 'Karawang', 'Purwakarta', 'Sukabumi', 'Tasikmalaya', 'Garut']
  },
  {
    region: 'JAWA TENGAH & DIY',
    cities: ['Yogyakarta', 'Semarang', 'Solo', 'Magelang', 'Pekalongan']
  },
  {
    region: 'JAWA TIMUR',
    cities: ['Surabaya', 'Malang', 'Sidoarjo', 'Gresik', 'Kediri']
  },
  {
    region: 'BALI & NUSA TENGGARA',
    cities: ['Bali - Badung (Canggu/Seminyak)', 'Bali - Ubud', 'Denpasar', 'Lombok', 'Sumbawa']
  },
  {
    region: 'SUMATERA',
    cities: ['Medan', 'Palembang', 'Pekanbaru', 'Batam', 'Padang', 'Bandar Lampung']
  },
  {
    region: 'KALIMANTAN',
    cities: ['Samarinda', 'Balikpapan', 'Pontianak', 'Banjarmasin']
  },
  {
    region: 'SULAWESI',
  ...
  {
    region: 'LAINNYA',
    cities: ['Ambon', 'Jayapura', 'Sorong', 'Pangkal Pinang']
  }
];


export const CITY_INSIGHTS_DATA: Record<string, CityInsight> = {
  'Jakarta Selatan': {
    location: 'Jakarta Selatan',
...
export const DEFAULT_INDONESIA_STATS: CityInsight = {
