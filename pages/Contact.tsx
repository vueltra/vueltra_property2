...
const Contact: React.FC<ContactProps> = ({ onBack }) => {
  ...
  return (
    <div>
      {/* Header Blue Section */}
      <div className="bg-blue-600 text-white py-16 md:py-24 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
             ...
             <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                   ...
                   <div>
                      ...
                      <a href={`mailto:${settings?.contactEmail}`} className="text-blue-600 hover:underline">{settings?.contactEmail || 'Memuat...'}</a>
                   </div>
                </div>
          ...
          <div className="space-y-8">
             <div className="bg-white rounded-2xl shadow-md border border-slate-100 p-8 hover:shadow-lg transition-shadow">
                ...
                <a href={`mailto:press@vueltra.com`} className="text-blue-600 font-bold hover:underline text-sm">
                   Hubungi Tim PR &rarr;
                </a>
             </div>
