...
const Legal: React.FC<LegalProps> = ({ onBack }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <button onClick={onBack} className="mb-6 text-slate-500 hover:text-slate-900 font-medium flex items-center gap-2">
        &larr; Kembali ke Beranda
      </button>

      <div className="text-center mb-10">
        <h1 className="text-3xl font-bold text-slate-900 mb-2">Pusat Legalitas & Privasi</h1>
        <p className="text-slate-500">Transparansi dan keamanan adalah prioritas kami di Vueltra.</p>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
        ...
        <div className="flex border-b border-slate-200 overflow-x-auto">
          <button 
            ...
            className={`flex-1 py-4 px-6 text-sm font-bold whitespace-nowrap transition-colors ${activeTab === 'terms' ? 'bg-blue-50 text-blue-800 border-b-2 border-blue-600' : 'text-slate-500 hover:text-slate-800 hover:bg-slate-50'}`}
          >
            Syarat & Ketentuan
          </button>
          <button 
            onClick={() => setActiveTab('privacy')}
            className={`flex-1 py-4 px-6 text-sm font-bold whitespace-nowrap transition-colors ${activeTab === 'privacy' ? 'bg-blue-50 text-blue-800 border-b-2 border-blue-600' : 'text-slate-500 hover:text-slate-800 hover:bg-slate-50'}`}
          >
            Kebijakan Privasi
          </button>
          <button 
            onClick={() => setActiveTab('disclaimer')}
            className={`flex-1 py-4 px-6 text-sm font-bold whitespace-nowrap transition-colors ${activeTab === 'disclaimer' ? 'bg-blue-50 text-blue-800 border-b-2 border-blue-600' : 'text-slate-500 hover:text-slate-800 hover:bg-slate-50'}`}
          >
            Disclaimer (Penafian)
          </button>
        </div>
        ...
        {/* Content */}
        <div className="p-8 text-slate-700 leading-relaxed text-sm md:text-base space-y-6 max-h-[70vh] overflow-y-auto">
          
          {activeTab === 'terms' && (
            <div className="animate-fade-in">
              <h2 className="text-xl font-bold text-slate-900 mb-4">Syarat dan Ketentuan Penggunaan</h2>
              ...
              <h3 className="font-bold text-slate-900 mt-4 mb-2">1. Definisi Layanan</h3>
              ...
              <h3 className="font-bold text-slate-900 mt-4 mb-2">2. Akun Pengguna</h3>
              ...
              <h3 className="font-bold text-slate-900 mt-4 mb-2">3. Konten Listing</h3>
              ...
              <h3 className="font-bold text-slate-900 mt-4 mb-2">4. Biaya dan Pembayaran</h3>
          ...
          {activeTab === 'privacy' && (
            <div className="animate-fade-in">
              <h2 className="text-xl font-bold text-slate-900 mb-4">Kebijakan Privasi</h2>
              ...
              <h3 className="font-bold text-slate-900 mt-4 mb-2">1. Data yang Kami Kumpulkan</h3>
              <ul className="list-disc pl-5 space-y-1">
              ...
              <h3 className="font-bold text-slate-900 mt-4 mb-2">2. Penggunaan Data</h3>
              ...
              <h3 className="font-bold text-slate-900 mt-4 mb-2">3. Keamanan Data</h3>
          ...
          {activeTab === 'disclaimer' && (
            <div className="animate-fade-in">
              <h2 className="text-xl font-bold text-slate-900 mb-4">Penafian (Disclaimer)</h2>
              ...
              <h3 className="font-bold text-slate-900 mt-4 mb-2">1. Transaksi Properti</h3>
              ...
              <h3 className="font-bold text-slate-900 mt-4 mb-2">2. Verifikasi Data Properti</h3>
              ...
              <h3 className="font-bold text-slate-900 mt-4 mb-2">3. Batasan Tanggung Jawab</h3>
        ...
        <div className="bg-slate-50 px-8 py-4 border-t border-slate-200 text-xs text-slate-400 text-center">
